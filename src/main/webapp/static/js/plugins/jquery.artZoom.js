...
$.fn.artZoom = function (config) {
	...
	tmpl = [
		'<div class="ui-artZoom-toolbar" style="display:none">',
			'<span class="ui-artZoom-buttons" style="display:none">',
				'<a data-go="left" class="ui-artZoom-left"><span></span>',
					config.left,
				'</a>',
				'<a data-go="right" class="ui-artZoom-right"><span></span>',
					config.right,
				'</a>',
				'<a data-go="source" class="ui-artZoom-source"><span></span>',
					config.source,
				'</a>',
				'<a data-go="hide" class="ui-artZoom-hide"><span></span>',
					config.hide,
				'</a>',
			'</span>',
	...
	//事件代理   live方法在jQuery1.9中不在支持,使用on的方式
